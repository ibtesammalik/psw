...
public class ObjW000005 implements Serializable {
	...
	public ObjW000005(String cOBR_UNO, String tRADE_TYPE, String tRADER_IBAN, String tRADER_NTN, String tRADER_NAME,
			String fI_UNO) {
		super();
		COBR_UNO = cOBR_UNO;
